...
<html>
    ...
    <body>
        ...
        <main>
            <div>Привет! Меня зовут Анна Петерс, и я студентка второго курса 
            направления бизнес-информатика в НГТУ. Это уникальная программа, которая 
            объединяет в себе знания в области экономики, менеджмента и информационных технологий.</div>
            <div>В университете я изучаю широкий спектр дисциплин, от финансового менеджмента и
            маркетинга до программирования и баз данных. Это позволяет мне не только понимать бизнес-процессы, 
            но и применять IT-решения для их оптимизации.</div>
            <div>Я стремлюсь стать профессионалом, способным сочетать глубокое понимание бизнеса
            с техническими навыками. Моя цель — внедрять инновационные IT-решения, 
            которые помогут компаниям повысить эффективность и конкурентоспособность.</div>
            <div>Бизнес-информатика — это не просто сочетание двух слов, это путь к 
            созданию будущего, где технологии и бизнес будут идти рука об руку. 
            Я горжусь тем, что являюсь частью этого направления и готова вносить свой вклад в развитие этой сферы.</div>
            <img src="''' + path9 + '''">
